...
From the CURRENT WHOOP app (v5.452.0) command enum (apk so0/e.java) — commands whoomp never had:
  TOGGLE_PERSISTENT_R20 = 153,  TOGGLE_PERSISTENT_R21 = 154
Builders (apk lh0/f1.java, lh0/g1.java): payload = 2 bytes [REVISION_1=0x01, on?1:0].
