...
public enum WhoopCommand: UInt8, CaseIterable {
    ...
    /// app `mh0/b.java`). patternId indexes the device's preset patterns (GET_ALL_HAPTICS_PATTERN
    ...
    // MARK: Alarm commands (from APK so0/e.java — confirmed)
    ...
    /// SET_ALARM_TIME (66) payload: Rev1 form from APK `so0/e.java`.
