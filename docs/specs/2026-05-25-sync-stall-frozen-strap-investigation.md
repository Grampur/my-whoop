...
- **Device:** iPhone udid `00008140-000158E80281401C`, team `X4226N37ZF`, bundle
  `com.openwhoop.OpenWhoop`. Server device id `my-whoop` at `https://whoop.example.com`
  (Bearer key in the runbook §1 — ⚠️ committed, should be rotated). Cloudflare WAF 403s default
  UAs → use `curl`.
