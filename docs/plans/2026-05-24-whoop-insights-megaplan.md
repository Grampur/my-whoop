...
`00008140-000158E80281401C`, team `X4226N37ZF`. Server deploy: push → `ssh jpserver 'cd
...
- [ ] `cd ios && xcodegen generate && xcodebuild -project OpenWhoop.xcodeproj -scheme OpenWhoop
  ...
  DEVELOPMENT_TEAM=X4226N37ZF CODE_SIGN_STYLE=Automatic build` → `xcrun devicectl device install app
  --device 00008140-000158E80281401C build/dd/Build/Products/Debug-iphoneos/OpenWhoop.app`.
